...
export default function LabibaCard() {
    const contact = {
        name: "Rushamiah Labiba",
        role: "Assistant Business Development Manager",
        company: "UB Nutraceuticals Ltd.",
        email: "labiba@ub-nutra.com",
        phone: "+880 1318 320 538",
        address: "Beacon Business Centre, 9/B/2, Toyenbee Circular Road, Motijheel, Dhaka.",
        photo: "https://ui-avatars.com/api/?name=Rushamiah+Labiba&background=D32F2F&color=fff&size=512"
    };
...
END:VCARD`;
            ...
            link.href = url;
            link.setAttribute("download", "Rushamiah_Labiba.vcf");
