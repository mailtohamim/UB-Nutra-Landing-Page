...
export default function RahilCard() {
    const contact = {
        name: "Md Rahil Rayhan Farid",
        role: "Executive",
        company: "UB Nutraceuticals Ltd.",
        email: "rahil@ub-nutra.com",
        phone: "+880 1980 414 182",
        address: "Beacon Business Centre, 9/B/2, Toyenbee Circular Road, Motijheel, Dhaka.",
        photo: "https://ui-avatars.com/api/?name=Md+Rahil+Rayhan+Farid&background=D32F2F&color=fff&size=512"
    };
...
END:VCARD`;
            ...
            link.href = url;
            link.setAttribute("download", "Md_Rahil_Rayhan_Farid.vcf");
