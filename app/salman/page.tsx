...
export default function SalmanCard() {
    const contact = {
        name: "Md Abu Salman Rana",
        role: "Senior Executive",
        company: "UB Nutraceuticals Ltd.",
        email: "salman@ub-nutra.com",
        phone: "+880 1938 850 324",
        address: "Beacon Business Centre, 9/B/2, Toyenbee Circular Road, Motijheel, Dhaka.",
        photo: "https://ui-avatars.com/api/?name=Md+Abu+Salman+Rana&background=D32F2F&color=fff&size=512"
    };
...
END:VCARD`;
            ...
            link.href = url;
            link.setAttribute("download", "Md_Abu_Salman_Rana.vcf");
